export const createFilmCardTemplate = () => (
  `<article class="film-card">
    ...
    <img src="./images/posters/sagebrush-trail.jpg" alt="" class="film-card__poster">
      <p class="film-card__description">Sentenced for a murder he did not commit,
      John Brant escapes from prison determined to find the real killer. By chance Brant's narrow escap…</p>
      ...
      <div class="film-card__controls">
        ...
        film-card__controls-item--active" type="button">
          Add to watchlist
        </button>
